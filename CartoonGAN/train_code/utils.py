...
def color_shift(image1, image2, mode='uniform'):
    ...
    if mode == 'normal':
        ...
        b_weight = tf.random.normal(shape=[1], mean=0.014, maxval=0.214)
        g_weight = tf.random.normal(shape=[1], mean=0.487, maxval=0.687)
        r_weight = tf.random.normal(shape=[1], mean=0.199, maxval=0.399)
